---
layout: post
title: "Like ~~Dylan~~ Prince in the Movies I: Theory"
...
<s>Some notes on actor information: I didn't exclude cameo appearances in the actor totals. The effect of this is unclear, as more successful actors have more of these roles, but the movies didn't necessarily perform well or even better than their main-billed movies. Also, I noticed that animation films didn't have prominent voice actors until more recently in the dataset. It'd be interesting to see if that actually contributes to financial success.</s>
